...
set_param('Parametrica/FIXED CHASSIS/BODY/FR HARDPOINTS','Commented','on');
...
set_param('Parametrica/FIXED CHASSIS/FR SUSPENSION','Commented','on');
...
set_param('Parametrica/FIXED CHASSIS/ACTUATOR FR','Commented','on');
